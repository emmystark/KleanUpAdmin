  ...
  return (
    <>
      <div>
        ...
        />
        {/* {showAdditionalDiv4 && ( */}
        <div className="lg:w-1/3 w-96 h-screen-1 bg-white p-8 z-30 lg:top-20 top-5 absolute lg:left-1/3 rounded-lg">
          <div>
            <FontAwesomeIcon
              icon={faXmark}
          ...
          <div className="text-sm">
            ...
            <br />
            <textarea className="lg:w-96 w-80 h-40 mt-4 text-black placeholder:text-black bg-gray-50 focus:outline-none pl-5 pt-5 border rounded-md" placeholder="Unfortunately, my schedule is fully booked for the requested date and time, and I won't be able to accommodate this job without compromising the quality of service for existing commitments. Apologies for any inconvenience caused." />
          </div>
