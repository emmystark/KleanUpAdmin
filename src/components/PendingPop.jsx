  ...
  return (
    <>
      <div >
        ...
        />
        {/* {showAdditionalDiv4 && ( */}
        <div className="lg:w-1/3 w-96 lg:h-screen-1 bg-white p-8 z-30 top-5 lg:top-20 absolute lg:left-1/3 rounded-lg">
          <div>
          <FontAwesomeIcon
                icon={faXmark}
          ...
          <button className="lg:px-36 px-28 py-2 text-white bg-blue-500 whitespace-nowrap mt-12 rounded-lg">
            Send Job alert
          </button>
        </div>
        {/* )} */}
