    ...
    <>
      <div >
        ...
        <div className="overflow-scroll">
          <div className="lg:whitespace-pre-wrap whitespace-nowrap lg:text-base text-xs -left-20 w-96  lg:w-[40%] h-screen-1 bg-white p-8 z-50 top-0 absolute lg:left-[55%] ml-16 rounded-lg">
            <div className="">
              <FontAwesomeIcon
                icon={faXmark}
