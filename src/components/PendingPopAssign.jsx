  ...
  return (
    <>
      <div>
        ...
        />
        {/* {showAdditionalDiv15 && ( */}
          <div className="lg:w-1/3 w-96 h-screen-1 bg-white lg:whitespace-pre-wrap whitespace-nowrap p-8 z-30 top-24 lg:top-40 absolute lg:left-1/3 rounded-lg">
            <div>
              <FontAwesomeIcon
                icon={faXmark}
            ...
            <label className="flex items-center px-3 py-4 bg-blue-100 rounded-lg border-2 border-blue-400 mt-5">
              ...
              <input
                type="radio"
                className="form-checkbox relative lg:left-5 -left-10 text-blue-500 h-5 w-5 rounded-2xl ml-28"
              />
            </label>
            <label className="flex items-center px-3 py-4 bg-blue-100 rounded-lg border-2 border-blue-400 mt-5">
              <span className="ml-2">Forward job to all cleaners</span>
              <input
                type="radio"
                className="form-checkbox relative lg:left-5 -left-10 text-blue-500 h-5 w-5 rounded-full ml-28"
              />
            </label>
            <button className="lg:px-40 px-32 py-2 text-white bg-blue-500 whitespace-nowrap mt-12 rounded-lg">
              Forward
            </button>
          </div>
        {/* )} */}
