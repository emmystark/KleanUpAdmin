  ...
  return (
    <>
      <div className={`overflow-x-hidden ${COLOR} opacity-${opacityValue}`}>
        ...
        <nav
          className="ml-1/3 z-20 bg-white lg:left-80 fixed lg:h-16 h-40 p-4 lg:p-7 lg:pt-3  w-screen "
        ...
        >
          ...
          <div className="relative lg:hidden z-40 ">
            ...
            {openMenu && (
              <div
                className="fixed top-0 left-0 w-[100%] h-[100%] bg-black opacity-70 z-30 via-transparent from-gray-100 to-gray-100"
                onClick={toggleMenu}
              />
            )}
            <div className="z-50 absolute right-40 md:right-[70%]">
        ...
        {showAdditionalDiv && (
          ...
          >
            <div className="top-32 relative left-6 ">
              <p className="cursor-pointer text-white text-center bg-blue-600 float-right lg:-left-96 py-3 fixed lg:mt-0 -mt-32 z-20 left-48 md:left-[75%] lg:relative w-44 whitespace-nowrap font-semibold rounded-lg">
                Manage requests
              </p>
            </div>
        ...
        {showAdditionalDiv3 && (
          ...
          >
            ...
            <div className="h-screen-3 lg:w-screen-3 left-10 pl-4 pt-9 relative -40">
              <div className="bg-white p-4 pl-6 w-[104%] right-7 relative">
                ...
                <div>
                  <div className="lg:flex lg:space-x-7 mt-9">
                    ...
                    <div className="whitespace-nowrap lg:mt-0 mt-8">
                      <p className="font-semibold">Professionalism</p>
                      <p className="text-sm mt-1">
                        Rating for professionalism received
                      </p>
                  ...
                  <div className="mt-8">
                    ...
                    <p className="text-xs p-4 border border-gray-500 mt-3 rounded-xl lg:w-[100%] lg:whitespace-nowrap whitespace-pre-wrap w-72">
          ...
          >
            ...
            <div className="bg-white h-screen-3 lg:w-screen-3 overflow-x-scroll left-5 mr-7 lg:left-6 pl-4 pt-9 relative top-36 whitespace-nowrap">
              ...
              <div className="flex mt-1 space-x-10 relative py-3 px-4 whitespace-nowrap  text-sm">
                <p className="relative right-0 whitespace-nowrap">
                  11/5/2023 8:00.00
                </p>
                <p className="whitespace-nowrap relative -left-5">
                  Samson James
                </p>
                <p className="relative -left-5">123 Maple Street...</p>
                <p className="relative -left-5 whitespace-nowrap">Regular cleaning</p>
                <p className="relative -left-2 whitespace-nowrap">Please focus on kitchen...</p>
                <p className="font-semibold lg:px-2 px-5 lg:w-24 w-60 rounded-xl py-1 relative -left-4 bg-gray-100">
                  Accept
                <FontAwesomeIcon
                icon={faChevronDown}
                className="text-sm relative left-[12%] top-0.5 cursor-pointer"
              />
                </p>
              </div>
              <div className="flex mt-1 space-x-10 relative py-3 px-4 whitespace-nowrap  text-sm">
                ...
                <p className="relative -left-5">123 Maple Street...</p>
                <p className="relative -left-5 whitespace-nowrap">Office cleaning</p>
                <p className="relative -left-0 whitespace-nowrap">Please focus on kitchen...</p>
                <p className="font-semibold lg:px-2 px-5 lg:w-24 w-60 rounded-xl py-1 relative -left-2 bg-gray-100">
                  Decline
                <FontAwesomeIcon
                icon={faChevronDown}
                className="text-sm relative left-[12%] top-0.5 cursor-pointer"
              ...
              <div className="flex mt-1 space-x-10 relative py-3 px-4 whitespace-nowrap  text-sm">
                ...
                <p className="relative -left-2 whitespace-nowrap">
              ...
              <div className="flex mt-1 space-x-10 relative py-3 px-4 whitespace-nowrap  text-sm">
                ...
                <p className="relative -left-0 whitespace-nowrap">
                  Please focus on kitchen...
                </p>
                <p className="font-semibold lg:px-2 px-5 lg:w-24 w-60 rounded-xl py-1 relative -left-2 bg-gray-100">
                  Decline
